...
/**
 * This class is using Expandable Bouncer Layout
 */
public class MaintainanceCollectionExpandableBouncerLayout extends LinearLayout {
    ...
    public MaintainanceCollectionExpandableBouncerLayout(Context context) {
        this(context, null);
    }

    public MaintainanceCollectionExpandableBouncerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MaintainanceCollectionExpandableBouncerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(21)
    public MaintainanceCollectionExpandableBouncerLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MaintainanceCollectionExpandableBouncerLayout);
            mDuration = ta.getInt(R.styleable.MaintainanceCollectionExpandableBouncerLayout_duration, DEFAULT_DURATION);
            mIsClickToToggle = ta.getBoolean(R.styleable.MaintainanceCollectionExpandableBouncerLayout_clickToToggle, false);
            mIsExpand = ta.getInteger(R.styleable.MaintainanceCollectionExpandableBouncerLayout_initialState, TYPE_INIT_COLLAPSE) == TYPE_INIT_EXPAND;
            ta.recycle();
        }
    ...
    private ValueAnimator createAnimator(final View view, int startPos, int endPos, int duration) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                int orientation = ((MaintainanceCollectionExpandableBouncerLayout) view).getOrientation();
