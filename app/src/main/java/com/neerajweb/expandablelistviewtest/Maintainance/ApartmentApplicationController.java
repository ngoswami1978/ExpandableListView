...
public class ApartmentApplicationController extends Application {

    public static final String TAG = ApartmentApplicationController.class.getSimpleName();
    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;
    private static ApartmentApplicationController mInstance;
