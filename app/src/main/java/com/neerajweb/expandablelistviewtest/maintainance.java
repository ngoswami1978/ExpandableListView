                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                ArrayList<modelLoadrptPeriodsMaintainance> objModelMaintainancerptPeriods =new ArrayList<modelLoadrptPeriodsMaintainance>();
                                //----------------------------------------
                                ...
                                if (success == 1) {
                                    ...
                                    for (int i = 0; i < ja.length(); i++) {
                                        model_rptPeriods = new modelLoadrptPeriodsMaintainance();
...
//                    params.put("yr",hashmapMonthYear.get("YEAR"));
    ...
    private void reDrawReportControl(ArrayList<modelLoadrptPeriodsMaintainance> objModelMaintainancerptPeriods,ArrayList<HashMap<String, String>> fillMaps)
    {
        int inttotalperiod;
        try {
            inttotalperiod=0;
            ...
            {
                modelLoadrptPeriodsMaintainance objperiod = (modelLoadrptPeriodsMaintainance) e.nextElement();
