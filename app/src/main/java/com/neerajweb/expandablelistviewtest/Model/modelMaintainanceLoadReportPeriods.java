...
public class modelMaintainanceLoadReportPeriods {
    ...
    public modelMaintainanceLoadReportPeriods() {}

    public modelMaintainanceLoadReportPeriods(int mMonth, int mmYear, String mMonthName, String mmMonthNameYear, int mTotalAmount, String mcustomfontName)
    {
        this.Month=mMonth;
        this.Year=mmYear;
